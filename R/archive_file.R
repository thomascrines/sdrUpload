...
#'
#' \code{archive_file} is an internal function that moves a file from a source directory to an archive directory.
#'
...
#'
#' \dontrun {
#' archive_file("path_of_source_directory", "path_of_archive_directory")
#' }
#'
#' @keywords internal
#'
...
archive_file <- function(source, archive, file) {
